...
import ScrollAnimated3D from './ScrollAnimated3D';
  ...
  return (
    <div className="min-h-screen relative">
      ...
      {/* Hero Section */}      <section className="relative overflow-hidden py-20 lg:py-32">
        <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/10 via-teal-500/10 to-blue-500/10"></div>        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:w-1/2 relative z-20">
            ...
            </div>            <h1 className="text-4xl sm:text-6xl font-bold text-gray-900 mb-6">
              Usa la{' '}
            ...
            </h1>            <p className="text-xl text-gray-600 mb-12 max-w-2xl leading-relaxed">
      ...
      <section className="py-20 bg-white/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:w-1/2 lg:ml-auto relative z-20">
            <div className="mb-16">
