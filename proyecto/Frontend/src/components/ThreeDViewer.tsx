...
const ThreeDViewer: React.FC<ThreeDViewerProps> = ({ category }) => {
  ...
  const categoryModels: Record<string, () => THREE.BufferGeometry> = {
  ...
  const categoryColors: Record<string, number> = {
    plastico: 0x10b981, // Emerald
    vidrio: 0x3b82f6,  // Blue
    papel: 0xf59e0b,   // Amber
    metal: 0x6b7280    // Gray
  };
  ...
  const createModel = (category: string) => {
